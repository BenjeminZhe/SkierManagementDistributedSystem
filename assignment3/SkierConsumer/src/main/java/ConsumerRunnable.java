    ...
    public void run() {
        try {
            ...
            DeliverCallback deliverCallback = (consumerTag, delivery) -> {
                ...
                String skierId;
                try {
                    skierId = String.valueOf(lift.getSkierId());
                    ...
                    input.add("dayId", JsonParser.parseString(String.valueOf(lift.getDayId())));
                } catch (Exception e) {
                    e.printStackTrace();
                ...
                try (Jedis jedis = pool.getResource()) {
                    jedis.sadd(skierId, new GsonBuilder().setPrettyPrinting().create().toJson(input));
                }
